-- A survey company wishes to gather groups of male customers from SUNNY Housekeeping with more than one
-- service provided in which these services are carried out by male supervisors for statistical purposes.
